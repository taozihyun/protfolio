        ...
        <div className="mt-3 grid grid-cols-3 gap-3">
          {group.images.slice(1).map((image, imageIndex) => (
            <ZoomableImage
              ...
              visualId={`other-work-${groupIndex}-image-${imageIndex + 1}`}
              defaultObjectFit="contain"
              captionPath={[
                "otherWorkGroups",
                groupIndex,
      ...
      <>
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-10">
          ...
          <ZoomableImage
            ...
            alt={group.images[0].alt}
            caption={group.images[0].caption}
            className="aspect-[4/3] w-full lg:col-span-4"
        ...
        <div className="mt-3 grid grid-cols-4 gap-3">
          ...
          <ZoomableImage
            ...
            className="col-span-1 aspect-[4/3] w-full"
