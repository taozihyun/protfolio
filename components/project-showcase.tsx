              ...
              {otherWorkGroups.map((group, groupIndex) => (
                <Reveal key={groupIndex}>
                  <VisualBlock
                    ...
                    mode="section"
                    className="grid gap-8 border-t border-[var(--line)] py-10 lg:grid-cols-12 lg:gap-10 lg:py-14"
                  >
  ...
  {group.images.length > 0 ? (
    group.images.map((image, imageIndex) => (
      <ZoomableImage
        ...
        className={
          group.images.length === 5
            ? imageIndex === 0
              ...
              : "col-span-6 aspect-[4/3] md:col-span-3"
            : imageIndex === 0
              ? "col-span-12 aspect-[16/9] md:col-span-6"
              : "col-span-6 aspect-[4/3] md:col-span-3"
        }
        sizes={
          group.images.length === 5
        ...
        defaultObjectFit={groupIndex === 1 ? "contain" : "cover"}
        captionPath={[
          "otherWorkGroups",
          groupIndex,
          "images",
